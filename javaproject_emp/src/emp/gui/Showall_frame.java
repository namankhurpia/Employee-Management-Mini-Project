...
public class Showall_frame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Showall_frame
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Showall_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Showall_frame().setVisible(true);
            }
        });
    }
